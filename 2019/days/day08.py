...
print(f'Part 2:')
for i in range(0, len(inputs), width):
    line = ' '.join(current[i:i+width]).replace('0', ' ').replace('1', '@')
    if line != '':
        print(line)
