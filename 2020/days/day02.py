...
The shopkeeper at the North Pole Toboggan Rental Shop is having a bad day. "Something'inputs wrong with our computers; we
...
def part1(inputs):
    ...
    for line in inputs:
        ...
        lower = int(rang.split('-')[0])
        upper = int(rang.split('-')[1])
...
def part2(inputs):
    ...
    for line in inputs:
        ...
        a = password[lower - 1] == letter
        b = password[upper - 1] == letter
...
puzzle_input = puzzle_input(2).split('\n')
